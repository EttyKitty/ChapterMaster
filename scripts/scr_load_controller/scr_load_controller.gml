...
function scr_load_controller(save_id) {
	try {
		...
		if ((obj_controller.command_set[20] == 0) && (obj_controller.command_set[21] == 0) && (obj_controller.command_set[22] == 0)) {
			obj_controller.command_set[20] = 1;
		}
		if ((obj_controller.command_set[23] == 0) && (obj_controller.command_set[24] == 0)) {
			obj_controller.command_set[24] = 1;
		}

		ini_read_real("Controller", "modest_livery", 0);
		ini_read_real("Controller", "progenitor_visuals", 0);
		var _recruit_data = return_json_from_ini("Recruit", "data", {names: [""], corruption: [0], distance: [0], experience: [0], training: [0], recruit_data: [{}]});
		...
		obj_controller.col_special = ini_read_real("Controller", "col_special", 0);
		obj_ini.col_special = obj_controller.col_special;
		obj_controller.trim = ini_read_real("Controller", "trimmed", 0);
		obj_ini.trim = obj_controller.trim;
		obj_ini.skin_color = ini_read_real("Controller", "skin_color", 0);
		obj_controller.skin_color = obj_ini.skin_color;
