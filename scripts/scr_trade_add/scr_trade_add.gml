function scr_trade_add(argument0) {
	...
	if (thinz!=0){
	    ...
	    if (argument0="Terminator Armour"){get_diag_integer("Terminator Armour wanted?",5,"t"+string(thinz),"Terminator Armour");}		 // TODO - remove
	    if (argument0="Tartaros"){trade_tnum[thinz]=1;tomp1=1;}																			 // TODO - remove
	    if (argument0="Land Raider"){trade_tnum[thinz]=1;tomp1=1;}																		 // TODO - remove
	    if (argument0="Castellax Battle Automata"){trade_tnum[thinz]=1;tomp1=1;}														 // TODO - remove
	    ...
	    if (argument0="Eldar Power Sword"){get_diag_integer("Eldar Power Swords wanted?",5,"t"+string(thinz),"Eldar Power Sword");}		 // TODO - remove
	    if (argument0="Archeotech Laspistol"){trade_tnum[thinz]=1;tomp1=1;}																 // TODO - remove
	    ...
	    if (argument0="Condemnor Boltgun"){get_diag_integer("Condemnor Boltguns wanted?",20,"t"+string(thinz),"Condemnor Boltgun");}	 // TODO - remove
	    if (argument0="Hellrifle"){get_diag_integer("Hellrifles wanted?",3,"t"+string(thinz),"Hellrifle");}								 // TODO - remove
	    if (argument0="Incinerator"){get_diag_integer("Incinerators wanted?",10,"t"+string(thinz),"Incinerator");}						 // TODO - remove
	    if (argument0="Crusader"){get_diag_integer("Crusaders wanted?",5,"t"+string(thinz),"Crusader");}
	    if (argument0="Exterminatus"){trade_tnum[thinz]=1;tomp1=1;}																		 // TODO - consider removing
	    if (argument0="Cyclonic Torpedo"){trade_tnum[thinz]=1;tomp1=1;}																	 // TODO - consider removing
	    if (argument0="Eviscerator"){get_diag_integer("Eviscerators wanted?",10,"t"+string(thinz),"Eviscerator");}						 // TODO - remove
	    if (argument0="Heavy Flamer"){get_diag_integer("Heavy Flamers wanted?",10,"t"+string(thinz),"Heavy Flamer");}					 // TODO - remove
	    if (argument0="Inferno Bolts"){trade_tnum[thinz]=20;tomp1=20;}																	 // TODO - remove
	    ...
	    if (argument0="Power Klaw"){get_diag_integer("Power Klaws wanted?",5,"t"+string(thinz),"Power Klaw");}							 // TODO - remove
